...
function Sidebar({ page, setPage, user, onLogout, isOwner = false, className = "", dark, onToggleDark }) {
  ...
  const marcaNav = [
    { key: "dashboard", icon: "⬡", label: "Dashboard", roles: ["miner", "admin", "gerente", "vendedor"] },
    { group: "Gestão", items: [
      { key: "lojas", icon: "🏪", label: "Lojas", roles: ["miner", "admin"] },
      { key: "equipe", icon: "👥", label: "Equipe", roles: ["miner", "admin", "gerente"] },
      { key: "gestao_vendedores", icon: "🧑‍💼", label: "Gestão Vendedores", roles: ["miner", "admin", "gerente"] },
      { key: "metas", icon: "🎯", label: "Metas", roles: ["miner", "admin", "gerente", "vendedor"] },
      { key: "ranking", icon: "🏆", label: "Ranking", roles: ["miner", "admin", "gerente", "vendedor"] },
    ]},
    { group: "Vendas", items: [
      { key: "inbox", icon: "💬", label: "Inbox", roles: ["miner", "admin", "gerente", "vendedor"] },
      { key: "clientes", icon: "🙍", label: "Clientes", roles: ["miner", "admin", "gerente", "vendedor"] },
      { key: "segmentos", icon: "🎯", label: "Segmentos", roles: ["miner", "admin", "gerente"] },
      { key: "agenda", icon: "📋", label: "Agenda", roles: ["miner", "admin", "gerente", "vendedor"] },
      { key: "agenda_contatos", icon: "📅", label: "Agenda Contatos", roles: ["miner", "admin", "gerente", "vendedor"] },
      { key: "sugestoes", icon: "💡", label: "Sugestões", roles: ["miner", "admin", "gerente", "vendedor"] },
      { key: "pipeline", icon: "🔀", label: "Pipeline", roles: ["miner", "admin", "gerente", "vendedor"] },
      { key: "campanhas", icon: "📢", label: "Campanhas", roles: ["miner", "admin"] },
      { key: "automacoes", icon: "⚡", label: "Automações", roles: ["miner", "admin"] },
      { key: "respostas", icon: "⚡", label: "Respostas Rápidas", roles: ["miner", "admin", "gerente", "vendedor"] },
      { key: "relatorios", icon: "📊", label: "Relatórios", roles: ["miner", "admin", "gerente"] },
    ]},
    { group: "Retenção", items: [
      { key: "fidelidade", icon: "⭐", label: "Fidelidade", roles: ["miner", "admin", "gerente"] },
      { key: "indicacoes", icon: "🤝", label: "Indicações", roles: ["miner", "admin", "gerente"] },
    ]},
    { group: "Dados", items: [
      { key: "inteligencia", icon: "🧠", label: "Inteligência", roles: ["miner", "admin", "gerente"] },
      { key: "integracoes", icon: "🔌", label: "Integrações API", roles: ["miner", "admin"] },
      { key: "exportar", icon: "📤", label: "Dados & Export", roles: ["miner", "admin", "gerente"] },
      { key: "atividades", icon: "📜", label: "Atividades", roles: ["miner", "admin"] },
    ]},
    { group: "QR Code", items: [
      { key: "meuqr", icon: "📱", label: "Meu QR", roles: ["vendedor"] },
      { key: "qrcodes", icon: "📱", label: "QR Codes", roles: ["miner", "admin"] },
    ]},
    { group: "Config", items: [
      { key: "usuarios", icon: "🔐", label: "Usuários", roles: ["miner", "admin"] },
      { key: "permissoes", icon: "🛡", label: "Permissões", roles: ["miner", "admin"] },
      { key: "config", icon: "⚙", label: "Configurações", roles: ["miner", "admin"] },
    ]},
  ];
